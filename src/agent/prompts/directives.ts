...
- **Right Market Deck Synchronization**: The trader's right companion panel is synchronized to **#${clean}** (streaming sub-second WebSocket ticks, 8-level visual order book depth ladder, and live Perpetual Futures funding sentinel).
