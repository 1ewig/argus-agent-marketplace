...
export const CandlestickCanvas = forwardRef<CandlestickCanvasHandle, CandlestickCanvasProps>(
  function CandlestickCanvas({ candles, precision = 2, onCrosshairMove }, ref) {
    ...
    // Initialize Lightweight Charts canvas instance
    useEffect(() => {
      ...
      // Handle Crosshair hover legend sync
    ...
    return (
      <div className="relative w-full h-full min-h-[320px] overflow-hidden select-none">
