...
const CodeBlock = memo(function CodeBlock({ language, code, children }: CodeBlockProps) {
 ...
 * Declaring this statically prevents re-instantiating 17 component closures on every token chunk,
