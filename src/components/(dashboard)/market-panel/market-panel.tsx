...
export function MarketPanel({
  ...
  const sharedHeaderProps = {
    ...
    isAnalyzing: intelligence.isAnalyzing,
    isAnalysisFresh: intelligence.isAnalysisFresh,
    nextRunCountdown: intelligence.nextRunCountdown,
    onScanIntelligence: intelligence.handleScan,
  };
  ...
  const sharedBodyProps = {
    ...
    isIntelligenceActive,
    symbol,
    cleanSymbol: intelligence.cleanSymbol,
    ticker,
    orderBook,
    spotStatus,
    ...
    isIntelligenceLoading: intelligence.isLoading,
    isIntelligenceFetching: intelligence.isFetching,
    isIntelligenceError: intelligence.isError,
