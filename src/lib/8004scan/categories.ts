...
export const PRIMARY_PILLARS: CategoryConfig[] = [
  ...
  },
  {
    ...
    shortLabel: 'Grid',
    description:
      'Automated grid trading strategies, range-bound order books, and PancakeSwap market making.',
  ...
  },
  {
    ...
    description:
      'Lending liquidation sentinels, Venus collateral monitors, and margin safety sentinels.',
    searchTerms: ['health', 'health factor', 'liquidation', 'collateral'],
    icon: 'HeartPulse',
    variant: 'danger',
    priority: 3,
    isMandatory: true,
  ...
  },
  {
    ...
    description:
      'Concentrated liquidity ranges, automated LP auto-resetting, and dynamic portfolio balancers.',
    searchTerms: ['rebalance', 'rebalancing', 'lp', 'concentrated'],
    icon: 'RefreshCcw',
    variant: 'brand',
    priority: 4,
    isMandatory: true,
  ...
  {
    key: 'trading',
    label: 'DEX Trading & Execution',
    shortLabel: 'DEX Trading',
    description:
      'Automated DEX swaps, DCA accumulators, and smart order routing across BSC protocols.',
    searchTerms: ['trading', 'dca', 'swap', 'dex', 'arbitrage'],
  ...
  },
  {
    key: 'risk',
    label: 'Risk & Security',
    shortLabel: 'Risk & Safety',
    description:
      'Smart contract auditing, rug detection, and protocol risk telemetry.',
    searchTerms: ['risk', 'security', 'audit'],
    icon: 'ShieldAlert',
    variant: 'danger',
    priority: 6,
    isMandatory: false,
